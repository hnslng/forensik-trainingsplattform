...
function updateLabsWithChallenges() {
  ...
  if (typeof ContentData === "undefined" || !ContentData[labId]) return;

  ContentData[labId]['ch10-labs'] = function () {
    let html = '' +
  ...
  // CTF Challenges
  ContentData[labId]['ch11-ctf'] = function () {
    let html = '' +
...
window.getChallengeProgress = function() {
  var labId = (typeof App !== "undefined" && App.currentLab) ? App.currentLab : "linux-forensik";
  var key = "challenge-completed-" + labId;
